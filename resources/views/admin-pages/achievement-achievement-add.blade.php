...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Penghargaan</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('adminAchievementAchievementAddMethod') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label class="form-label">Nama Perlombaan</label>
                    <input type="text" class="form-control" name="judul" value="{{ old('nama') }}" placeholder="Nama Perlombaan ..." required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="form-control" rows="10" placeholder='Penghargaan yang didapat (Berikan tanda koma "," untuk setiap deskripsi yang ingin ditambahkan) ...' required>{{ old('deskripsi') }}</textarea>
