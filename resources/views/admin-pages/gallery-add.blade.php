...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('adminGalleryAddMethod') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <a href="{{ route('adminGallery') }}" class="btn btn-info float-right mr-3">Kembali</a>
            </form>
        </div>
    </div>
@endsection
