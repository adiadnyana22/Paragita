...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Tambah Label</h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('adminMerchLabelAddMethod') }}">
                @csrf
                <div class="mb-3">
                    <label class="form-label">Nama</label>
                    <input type="text" class="form-control" name="nama" placeholder="Nama Label ..." required>
